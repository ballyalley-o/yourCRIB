        ...
        <div className="hero min-h-screen flex items-center">
          <div className="flex-1 max w-4x1 mx-auto p-10">
            <div className="grid grid-cols-3 grid-rows-15 grid-flow-row gap-5">
              <div className="swiperSlideDiv col-span-3  inline-block pt-10 text-center p-10 ">
                <Slider />
              </div>
              ...
              <div className="col-span-3 hero min-h-screen static">
                <div className="hero-content flex-col lg:flex-row">
                  ...
                  <div>
                    ...
                    <p className="badge badge-accent text-lg ml-6">
                      Places for rent
                    </p>
                    <p className="p-6">
                ...
                <div className="hero-content flex-col lg:flex-row">
                  ...
                  <div>
                    ...
                    <p className="p-6">
                      Provident cupiditate voluptatem et in. Quaerat fugiat ut
                      assumenda excepturi exercitationem quasi. In deleniti
                      eaque aut repudiandae et a id nisi. Lorem ipsum dolor sit
                      amet.
                    </p>
              ...
              <div className="col-span-3 hero min-h-screen static">
                <div className="hero-content flex-col lg:flex-row">
                  ...
                  <div>
                    ...
                    <p className="badge badge-primary text-lg ml-6">
                      Places to Buy
                    </p>
                    <p className="p-6">
                      Provident cupiditate voluptatem et in. Quaerat fugiat ut
